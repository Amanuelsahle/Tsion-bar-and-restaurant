      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b pb-4" style={{ borderColor: "var(--border)" }}>
        <div>
          ...
          <p
            ...
            style={{ color: "var(--muted-foreground)" }}
          >
            Overview of store inventory, distribution, analytics, and reports.
          </p>
        </div>

        {/* Tab switcher */}
        <div
          className="flex items-center gap-1.5 p-1 rounded-xl shrink-0"
        ...
        >
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-semibold transition-all ${
              activeTab === "overview"
                ? "bg-[#c9a84c] text-[#0f1117] shadow-sm font-bold"
          ...
          {role === "manager" && (
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  { label: "Add New Item", action: () => onNavigate("items"), primary: true },
                  { label: "Add Stock", action: () => onNavigate("store"), primary: false },
                  {
                    label: "Give Items to Bar",
                    action: () => onNavigate("give-to-bar"),
                    primary: false,
                  },
                  { label: "View Reports & Analytics", action: () => setActiveTab("reports"), primary: false },
                ].map((act) => (
                  <button
                    key={act.label}
                    onClick={act.action}
                    ...
                    style={{
                      background: act.primary
                        ...
                        : "var(--secondary)",
                      color: act.primary ? "#0f1117" : "var(--foreground)",
                      border: act.primary ? "none" : "1px solid var(--border)",
                    }}
                  >
                    {act.label}
                  </button>
